...
export namespace MessagePostedEvent {
  export type InputTuple = [message: Factory.MessageStruct];
  export type OutputTuple = [message: Factory.MessageStructOutput];
  export interface OutputObject {
    message: Factory.MessageStructOutput;
  }
...
export interface Factory extends BaseContract {
  ...
  ): TypedContractMethod<[], [Factory.MessageStructOutput[]], "view">;
  getFunction(
